<template>
  <div>
    <div style="display: flex;justify-content: space-between;">
      <el-button type="primary" icon="el-icon-plus" @click="showAddSalaryView">添加员工账套</el-button>
      <el-button type="success" icon="el-icon-refresh" @click="this.initSalaries()"></el-button>
    </div>
